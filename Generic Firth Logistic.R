...
Classification <- function(){
  cat("Classification using Firth Logistic Regression")
  ...
  glm.fit <- suppressWarnings(brglm(dep ~. , data = trainSplit, family = binomial))
...
Diagnostics <- function(){
  ...
  write.csv(Diagnostic_Parameters, "Firth - Diagnostic_Parameters.csv")
  ...
  write.csv(testSplit, "Predicted Class Data - Firth.csv")
  
  jpeg(filename = "ROC Curve Firth.jpg")
